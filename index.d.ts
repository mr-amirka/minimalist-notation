...
/// <reference path="../mn-utils/global.d.ts"/>

import * as Emitter from 'mn-utils/emitter';
import {
  cssPropertiesStringify,
  CssProps
} from 'mn-utils/css-properties-stringify-provider';

import { selectorsCompile } from './selectors-compile-provider';

declare namespace minimalistNotationProvider {

  export interface mnCompiler {
    (attrValue: string): void;
    checkOne: (attrValue: string) => void;
...
declare const minimalistNotationProvider: () => minimalistNotationProvider.MinimalistNotation;
